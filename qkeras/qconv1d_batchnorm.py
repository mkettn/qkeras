...
# ==============================================================================
"""Fold batchnormalization with previous QConv1D layers."""
...
class QConv1DBatchnorm(QConv1D):
  """Fold batchnormalization with a previous qconv1d layer."""
  ...
  def __init__(
    ...
    The first group of parameters correponds to the initialization parameters
      of a qconv1d layer. check qkeras.qconvolutional.qconv1d for details.
    ...
    super(QConv1DBatchnorm, self).__init__(
        filters=filters,
  ...
  def build(self, input_shape):
    super(QConv1DBatchnorm, self).build(input_shape)
